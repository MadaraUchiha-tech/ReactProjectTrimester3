  ...
  if (!manga) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <h1 className="text-4xl font-bold mb-4">Manga not found</h1>
        <button
          onClick={() => navigate('/')}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-gray-100 p-4 rounded-lg">
                <h3 className="text-gray-600 font-medium">Score</h3>
                <p className="text-2xl font-bold text-primary">{manga.score}</p>
              </div>
              <div className="bg-gray-100 p-4 rounded-lg">
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <h3 className="text-gray-600 font-medium">Chapters</h3>
                <p className="text-2xl font-bold text-primary">{manga.chapters || 'N/A'}</p>
              </div>
              <div className="bg-gray-100 p-4 rounded-lg">
                <h3 className="text-gray-600 font-medium">Volumes</h3>
