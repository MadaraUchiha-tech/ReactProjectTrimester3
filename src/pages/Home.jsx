...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      {/* Hero Section */}
      <div className="hero-section bg-dark dark:bg-gray-800">
        <div className="hero-content">
          <h1 className="text-5xl font-bold mb-6 text-white">Welcome to MangaWorld</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {displayedManga.length > 0 ? (
              ...
              {displayedManga.map((manga) => (
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    />
                    <div className="manga-card-overlay bg-black/60">
                      <div className="manga-card-content">
                        <h3 className="text-xl font-bold mb-2 text-white">{manga.title}</h3>
                        <div className="flex items-center gap-2 mb-2">
                          <span className="bg-primary/90 px-2 py-1 rounded text-sm text-white">
                            Score: {manga.score || 'N/A'}
                          </span>
                          <span className="bg-secondary/90 px-2 py-1 rounded text-sm text-white">
                            {manga.status}
                          </span>
                        </div>
          ...
          <div className="text-center py-12">
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-4">No manga found matching your filters</p>
            <button
